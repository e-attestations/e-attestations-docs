...
E105 | The establishment has been transferred to a new establishment
E111 | The supplier code in parameter is different from the existing supplier code for third party
E112 | The supplier code (thirdpartyCode) already used for another supplier
E113 | Non active ordering account
E121 | Impossible to create a dossier based on TVA for a french third party. Plesae use SIRET number
